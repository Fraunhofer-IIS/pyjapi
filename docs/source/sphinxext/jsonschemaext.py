"""JSON Schema Validation Extension for Sphinx.

Taken from https://github.com/json-schema-org/understanding-json-schema/blob/master/source/sphinxext/jsonschemaext.py
